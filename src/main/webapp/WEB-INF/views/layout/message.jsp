<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	if (!"".equals(request.getParameter("msg"))) {
		...
		<div class="alert alert-warning" role="alert"><%=deleteERROR %></div>
		<%}%>
		...
		<div class="alert alert-warning" role="alert"><%=editERROR %></div>
		<%}%>
		...
		<div class="alert alert-warning" role="alert"><%=addERROR %></div>
		<%}%>
		
		<% if ("addexists".equals(msg)) { %>
		<div class="alert alert-warning" role="alert"><%=addexists %></div>
		<%}%>
